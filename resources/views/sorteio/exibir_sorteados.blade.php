...
@section('content')
    ...
    <div class="row">
        <div class="p-2 text-center bg-body-tertiary">
            ...
            @if($listaSorteada->get(0)->imagem)
                <img src="{{ asset('storage/images/' . $listaSorteada->get(0)->imagem); }}" width="200" height="200" alt="user" class="rounded-circle">
            @else
                <img src="/user-default.png" alt="user" width="200" height="200" class="rounded-circle">
            @endif  
